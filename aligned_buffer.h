...
public:
    ...
    //using std::vector<T,ab_internal_::alloc<T,alignment> >::swap;
    ...
    inline void swap( aligned_buffer &other ) {
    	std::vector<T,ab_internal_::alloc<T,alignment> >::swap( (std::vector<T,ab_internal_::alloc<T,alignment> > &) other );
    }
};
